      ...
      <div className={styles.projetos}>
        ...
        <div className={styles.gridContainer}>
          ...
          <div className={styles.projeto}>
           ...
           <div className={styles.projeto}>
            <div className={styles.imagemContainer} onClick={() => handleImageClick('casamento')}>
              <img src={casorio} alt="casamento" className={styles.imagem_aviao} />
              <div className={styles.overlay}>
                <div className={styles.textoOverlay}>
                  <img src={nextIcon} alt="overlay" className={styles.imageinter} />
                  <img src={tailwindIcon} alt="overlay" className={styles.imageinter} />
                  

                </div>
              </div>
            </div>
            <h2 className={styles.titulo_projeto_texto}>Projeto do meu casamento</h2>
            {selectedProject === 'casamento' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://casamento-one-roan.vercel.app/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/casamento" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Casamento</strong><br/>
                    é uma aplicação web desenvolvida em Nextjs e tailwind<br/>
                    </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
              </div>
           ...
           <div className={styles.projeto}>
            <div className={styles.imagemContainer} onClick={() => handleImageClick('busca')}>
            ...
            <h2 className={styles.titulo_projeto_texto}>Busca de restaurantes</h2>
            {selectedProject === 'busca' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://buscas-de-restaurantes.vercel.app" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/Buscas-de-restaurantes" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Busca de restaurantes</strong><br/>
                       é desenvolvido com Nextjs , nodejs e tailwind<br/>
                    </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
              </div>
              ...
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  ...
                  <p className={styles.paragrafo_projeto}> Projeto feito sobre o  <strong className={styles.color}> Marcos Bizzarri </strong>,<br/>
                    é uma aplicação web desenvolvida em HTML, CSS e JS.<br/>
                   </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
              </div>
          ...
          <div className={styles.projeto}>
            ...
            <h2 className={styles.titulo_projeto_texto}>Quiz sobre HTML, CSS e JS</h2>
            {selectedProject === 'perguntas' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://marcosbizzarri.github.io/perguntas-html-css-js/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/perguntas-html-css-js" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Perguntas</strong><br/>
                    é uma aplicação web desenvolvida em HTML, CSS e JS.<br/>
                    </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
          ...
          <div className={styles.projeto}>
            ...
            <h2 className={styles.titulo_projeto_texto}>Projeto Banco Santander</h2>
            {selectedProject === 'santander' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://marcosbizzarri.github.io/projeto-santander/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/projeto-santander" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Santander</strong><br/>
                    é uma aplicação web desenvolvida em HTML, CSS.<br/>
                    </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
              </div>
          ...
          <div className={styles.projeto}>
            <div className={styles.imagemContainer} onClick={() => handleImageClick('facebook')}>
            ...
            <h2 className={styles.titulo_projeto_texto}>Facebook com cores do Instagram</h2>
            {selectedProject === 'facebook' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                <a href="https://marcosbizzarri.github.io/facebook-pagina/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                <a href="https://github.com/MarcosBizzarri/facebook-pagina" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Facebook Clone</strong><br/>
                    é uma aplicação web desenvolvida em HTML, CSS.<br/>
                   </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
          ...
          <div className={styles.projeto}>
            ...
            <h2 className={styles.titulo_projeto_texto}>Gerenciador de Academia</h2>
            {selectedProject === 'academia' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                <a href="https://marcosbizzarri.github.io/gestao-academia/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                <a href="https://github.com/MarcosBizzarri/gestao-academia" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> O projeto <strong className={styles.color}>Gerenciador de Academia</strong><br/>
                    é uma aplicação web desenvolvida em HTML, CSS e JS.<br/>
                  </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
          ...
          <div className={styles.projeto}>
            ...
            {selectedProject === 'quizeducacional' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://quiz-educacional-7a06f.web.app/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/Quiz-Educacional" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> Projeto  <strong className={styles.color}> Quiz Educacional </strong>,<br/>
                    é uma aplicação web desenvolvida em React.<br/>
                   </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
          ...
          {/* <div className={styles.projeto}>
            ...
            {selectedProject === 'crud' && (
              <div className={styles.videoContainer}>
                ...
                <div className={styles.links}>
                  <a href="https://sistema-de-cadastro-bizzarri.web.app/" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Projeto</a>
                  <a href="https://github.com/MarcosBizzarri/Crud-sistema" target="_blank" rel="noopener noreferrer" className="btn btn-primary mr-2">Ver Repositório</a>
                  <br/>
                  <br/>
                  <br/>
                  <p className={styles.paragrafo_projeto}> Projeto sobre  <strong className={styles.color}> CRUD </strong>,<br/>
                    é uma aplicação web desenvolvida em React.<br/>
                   </p>            
                </div>
                <button onClick={handleCloseVideo} className={styles.closeButton}>Fechar</button>
  ...
  <div className={styles.contatos}>
    ...
    <div className={styles.icons}>
      <div className={styles.icon}>
        <a href="mailto:marcos-bizzarri@hotmail.com" target="_blank" rel="noopener noreferrer" className={styles.buttonLink}>
          <div className={styles.box}>
      ...
      <div className={styles.icon}>
        <a href="https://api.whatsapp.com/send/?phone=5519994449107&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className={styles.buttonLink}>
          <div className={styles.box}>
      ...
      <div className={styles.icon}>
        <a href="https://linkedin.com/in/marcos-bizzarri" target="_blank" rel="noopener noreferrer" className={styles.buttonLink}>
          <div className={styles.box}>
      ...
      <div className={styles.icon}>
        <a href="https://github.com/MarcosBizzarri" target="_blank" rel="noopener noreferrer" className={styles.buttonLink}>
          <div className={styles.box}>
